            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
              <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl sm:text-3xl font-bold text-[#2c5e4e]">Pengangkut Sawit</h1>
                    </div>
                </div>
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
    ...
    {{-- Card 1: Total Brondolan Bulan Ini (IKON KARUNG) --}}
        ...
        <div class="flex items-start justify-between">
            ...
            <div class="w-12 h-12 rounded-xl bg-[#eaf4f1] flex items-center justify-center">
                <svg class="w-6 h-6 text-[#2c5e4e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 4L6 20h12l-1-16H7z"/>
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 4v3h6V4"/>
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10 8l-2 1M14 8l2 1"/>
                    <line x1="9" y1="11" x2="15" y2="11" stroke-width="1"/>
                    <line x1="9" y1="14" x2="15" y2="14" stroke-width="1"/>
                    <line x1="9" y1="17" x2="15" y2="17" stroke-width="1"/>
                </svg>
            </div>
        </div>
    </div>

    {{-- Card 2: Total Janjangan Bulan Ini (IKON TIMBANGAN) --}}
    <div class="bg-white rounded-2xl p-5 border border-gray-200 transition-all hover:shadow-md">
        <div class="flex items-start justify-between">
            <div>
    ...
    {{-- Card 3: Brondolan Hari Ini (IKON KARUNG) --}}
    <div class="bg-white rounded-2xl p-5 border border-gray-200 transition-all hover:shadow-md">
        <div class="flex items-start justify-between">
            <div>
            ...
            <div class="w-12 h-12 rounded-xl bg-[#eaf4f1] flex items-center justify-center">
                <svg class="w-6 h-6 text-[#2c5e4e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <line x1="9" y1="14" x2="15" y2="14" stroke-width="1"/>
                    <line x1="9" y1="17" x2="15" y2="17" stroke-width="1"/>
                    <!-- Buah sawit dalam karung -->
                    <circle cx="10.5" cy="13" r="0.8" stroke-width="1"/>
                    <circle cx="13.5" cy="13" r="0.8" stroke-width="1"/>
                    <circle cx="12" cy="15" r="0.8" stroke-width="1"/>
                </svg>
            </div>
        </div>
    ...
    {{-- Card 4: Janjangan Hari Ini (IKON TIMBANGAN) --}}
    <div class="bg-[#2c5e4e] rounded-2xl p-5 transition-all hover:shadow-md">
        ...
        <div class="mt-3 pt-3 border-t border-white/20">
            <span class="inline-flex items-center gap-1 px-2 md:px-3 py-1 rounded-full text-xs font-medium bg-white/20 text-white">
                ...
                @if($janjanganHariIni > 0) Sudah Input @else Belum Input @endif
            </span>
        </div>
    </div>
                        ...
                        @elseif(!empty($absenHariIni) && $absenHariIni->check_in)
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="bg-[#eaf4f1] rounded-xl p-6 border border-[#2c5e4e]/20 text-center">
                                    ...
                                    @php
                                        $batasWaktu = \Carbon\Carbon::createFromTime(7, 30, 0);
                                ...
                                <div class="bg-[#eaf4f1] rounded-xl p-6 border border-[#2c5e4e]/20 text-center">
                                    ...
                                    @else
                                        <div class="py-6">
                                            ...
                                            <p class="text-gray-500 font-medium">Belum Check Out</p>
                                            <p class="text-xs text-gray-400 mt-1">Anda masih dalam sesi kerja</p>
                                            @if(!$hasPanenHariIni)
                                                <p class="text-xs text-amber-600 mt-2"> Input panen dulu sebelum checkout</p>
                                            @endif
                                        </div>
                                    @endif
                                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-6">
            ...
            <div class="bg-white rounded-xl p-5 flex gap-4 border border-gray-200 transition-all hover:border-[#eaf4f1] hover:shadow-sm">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 mb-2">Lihat pengumuman terbaru dari pihak atasan</p>
